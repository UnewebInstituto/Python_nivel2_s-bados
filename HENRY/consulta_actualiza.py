...
while True:
    ...
    print("Id:", datos[0][0])
    print("Cédula:", datos[0][1])
    print("Nombre:", datos[0][2])
    print("Apellido:", datos[0][3])
    print("Fecha Nacimiento:", datos[0][5])
    print("Dirección Actual:", datos[0][4])
    nuevaDireccion = input("Nueva dirección:")
    if (nuevaDireccion.isspace()):
        nuevaDireccion = datos[0][4]
    print("Nueva dirección:", nuevaDireccion)
    print("Id del registro:", id)
    sql = "UPDATE personas SET direccion = %s WHERE id = %s"
    valores = (nuevaDireccion, id)
